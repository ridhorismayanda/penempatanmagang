...
error_reporting(0);
session_start();
if(!isset($_SESSION['logged_in_guru'])){
  header("Location: login.php");
  }
$session = $_SESSION['logged_in_guru'];
$query  = "SELECT * FROM GURU WHERE GURU_ID='$session'";
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a class="ganti_password" id="ganti_password">Ganti Password</a></li>
          </ul>
...
<div class="box-body">
                <div class="form-group">
                  <input type="hidden" class="form-control user_id" id="user_id" name="user_id" placeholder="Password" value="<?php echo $_SESSION['logged_in_guru']; ?>">
