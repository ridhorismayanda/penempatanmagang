...
$query  = "SELECT * FROM SISWA AS S, JURUSAN AS J, LOCATION AS L WHERE S.JURUSAN_ID=J.JURUSAN_ID AND S.SISWA_ID='".$session."'";
$result = mysqli_query($mysqli,$query)or die(mysqli_error());
$row     = mysqli_fetch_array($result);

$query3  = "SELECT * FROM LAPORAN AS L, SISWA AS S, LOCATION AS LC WHERE  LC.LOCATION_ID=L.LOCATION_ID AND L.SISWA_ID=S.SISWA_ID AND S.SISWA_ID='".$session."' ORDER BY L.LAPORAN_TANGGAL DESC";
$result3 = mysqli_query($mysqli,$query3)or die(mysqli_error());
$row3     = mysqli_fetch_array($result3);

$query1  = "SELECT * FROM SISWA AS S, PENILAIAN AS N WHERE S.SISWA_ID=N.SISWA_ID AND S.SISWA_ID='".$session."' ";
...
<div class="row">
  <div class="col-md-3"><img src="http://halaman-siswa.esy.es/modules/images/<?php echo $row['SISWA_NIS'];  ?>" width="200px"/></div>
